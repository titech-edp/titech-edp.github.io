...
```
[10:00-10:10] アイスブレイク「不満を叫ぶ」［田尻、水野］ / Icebreak [Tajiri, Mizuno]
[10:10-10:20] ガイダンス［齋藤］/ Guidance [Saito]
[10:30-12:15] チーム発表 / Presentation
[*12:15-13:20] お昼 / Lunch
[13:20-15:50] グループワーク / Group Activity
[14:00-15:00] 講義［照井］ / Lecture [Terui]
[15:00-15:50] グループワーク / Group Activity
```
...
- 準備・会場設営（学生向け）：
- 申し込み：<https://cbec-titech.doorkeeper.jp/events/69767>
...
[11:00-11:30] デモの準備 / Preparation for the demo
| - 作成したプロトタイプ / Prototype
| - 電源など必要なもの / Power strip etc. whatever you need
| - 机の配置 / Desk layout
| - 接続チェック / Monitor check
...
| ご挨拶とEDPの概要説明［齋藤］
  プレゼンテーション：
| - 協力企業からのプレゼンテーション（3分） / Presentation by the Corporate Partner
|  （1. テーマ説明、2. EDPの講評）
| - 担当チーム(1)からのプレゼンテーション（8分） / Presentation by Team 1
| - 担当チーム(2)からのプレゼンテーション（8分） / Presentation by Team 2
|
| × 5（合計5社10チーム）
|
| （途中で休憩を何度か挟みます）
